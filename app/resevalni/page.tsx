...
const ResevalniPsi = () => {
    return (
        <section className="flex flex-col container px-5 md:px-0 mt-8 mx-auto min-h-screen shadow-xl shadow-darkGrey relative">
            ...
            <div className="flex md:relative mx-auto items-center max-w-full h-[500px] justify-center">
                <Image
                    src={RescueDogs}
                ...
                <div className="md:absolute flex flex-col md:-bottom-20 bg-darkGrey w-3/4 max-h-2/5 py-10 mx-auto text-center rounded-lg text-whiter shadow-xl shadow-dark">
