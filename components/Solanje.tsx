...
const Solanje = () => {
    return (
        <div className="flex  items-center justify-center bg-darkGrey text-whiter py-12 px-3">
            <div className="flex flex-col items-center justify-center  md:max-w-3xl">
                ...
                <div className="flex mx-auto mt-6 text-whiter">
                    <PhoneIcon className="h-6 w- mr-4" />
                    <p>+386 41 855 924</p>
                </div>
                <div className="flex mx-auto mt-4 items-center text-whiter ">
