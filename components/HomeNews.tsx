...
const HomeNews = () => {
    ...
    return (
        <section className="my-4 md:my-12 p-6 md:relative">
            ...
            <div className="flex flex-col items-center max-w-full md:max-w-6xl mx-auto text-dark mb-4 md:flex-row md:space-x-8 md:mb-0 ">
                <div className="hidden md:block border-y-8 border-alertOrange absolute top-30 w-screen left-0 -z-10 h-20"></div>
                {news.map((news, index) => (
                    <SingleNews
                        url={news.url}
                        key={index}
